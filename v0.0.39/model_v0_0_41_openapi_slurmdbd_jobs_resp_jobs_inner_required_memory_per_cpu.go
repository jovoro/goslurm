...
// checks if the V0041OpenapiSlurmdbdJobsRespJobsInnerRequiredMemoryPerCpu type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &V0041OpenapiSlurmdbdJobsRespJobsInnerRequiredMemoryPerCpu{}

// V0041OpenapiSlurmdbdJobsRespJobsInnerRequiredMemoryPerCpu Minimum memory in megabytes per allocated CPU
type V0041OpenapiSlurmdbdJobsRespJobsInnerRequiredMemoryPerCpu struct {
...
func NewV0041OpenapiSlurmdbdJobsRespJobsInnerRequiredMemoryPerCpu() *V0041OpenapiSlurmdbdJobsRespJobsInnerRequiredMemoryPerCpu {
	this := V0041OpenapiSlurmdbdJobsRespJobsInnerRequiredMemoryPerCpu{}
	return &this
}
...
func (o V0041OpenapiSlurmdbdJobsRespJobsInnerRequiredMemoryPerCpu) MarshalJSON() ([]byte, error) {
...
func (o V0041OpenapiSlurmdbdJobsRespJobsInnerRequiredMemoryPerCpu) ToMap() (map[string]interface{}, error) {
...
type NullableV0041OpenapiSlurmdbdJobsRespJobsInnerRequiredMemoryPerCpu struct {
	value *V0041OpenapiSlurmdbdJobsRespJobsInnerRequiredMemoryPerCpu
	isSet bool
}

func (v NullableV0041OpenapiSlurmdbdJobsRespJobsInnerRequiredMemoryPerCpu) Get() *V0041OpenapiSlurmdbdJobsRespJobsInnerRequiredMemoryPerCpu {
	return v.value
}

func (v *NullableV0041OpenapiSlurmdbdJobsRespJobsInnerRequiredMemoryPerCpu) Set(val *V0041OpenapiSlurmdbdJobsRespJobsInnerRequiredMemoryPerCpu) {
	v.value = val
	v.isSet = true
}

func (v NullableV0041OpenapiSlurmdbdJobsRespJobsInnerRequiredMemoryPerCpu) IsSet() bool {
	return v.isSet
}

func (v *NullableV0041OpenapiSlurmdbdJobsRespJobsInnerRequiredMemoryPerCpu) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableV0041OpenapiSlurmdbdJobsRespJobsInnerRequiredMemoryPerCpu(val *V0041OpenapiSlurmdbdJobsRespJobsInnerRequiredMemoryPerCpu) *NullableV0041OpenapiSlurmdbdJobsRespJobsInnerRequiredMemoryPerCpu {
	return &NullableV0041OpenapiSlurmdbdJobsRespJobsInnerRequiredMemoryPerCpu{value: val, isSet: true}
}

func (v NullableV0041OpenapiSlurmdbdJobsRespJobsInnerRequiredMemoryPerCpu) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableV0041OpenapiSlurmdbdJobsRespJobsInnerRequiredMemoryPerCpu) UnmarshalJSON(src []byte) error {
	v.isSet = true
