...
// checks if the V0041OpenapiSlurmdbdJobsRespJobsInnerTimeLimit type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &V0041OpenapiSlurmdbdJobsRespJobsInnerTimeLimit{}

// V0041OpenapiSlurmdbdJobsRespJobsInnerTimeLimit Maximum run time in minutes
type V0041OpenapiSlurmdbdJobsRespJobsInnerTimeLimit struct {
...
func NewV0041OpenapiSlurmdbdJobsRespJobsInnerTimeLimit() *V0041OpenapiSlurmdbdJobsRespJobsInnerTimeLimit {
	this := V0041OpenapiSlurmdbdJobsRespJobsInnerTimeLimit{}
	return &this
}
...
func (o V0041OpenapiSlurmdbdJobsRespJobsInnerTimeLimit) MarshalJSON() ([]byte, error) {
...
func (o V0041OpenapiSlurmdbdJobsRespJobsInnerTimeLimit) ToMap() (map[string]interface{}, error) {
...
type NullableV0041OpenapiSlurmdbdJobsRespJobsInnerTimeLimit struct {
	value *V0041OpenapiSlurmdbdJobsRespJobsInnerTimeLimit
	isSet bool
}

func (v NullableV0041OpenapiSlurmdbdJobsRespJobsInnerTimeLimit) Get() *V0041OpenapiSlurmdbdJobsRespJobsInnerTimeLimit {
	return v.value
}

func (v *NullableV0041OpenapiSlurmdbdJobsRespJobsInnerTimeLimit) Set(val *V0041OpenapiSlurmdbdJobsRespJobsInnerTimeLimit) {
	v.value = val
	v.isSet = true
}

func (v NullableV0041OpenapiSlurmdbdJobsRespJobsInnerTimeLimit) IsSet() bool {
	return v.isSet
}

func (v *NullableV0041OpenapiSlurmdbdJobsRespJobsInnerTimeLimit) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableV0041OpenapiSlurmdbdJobsRespJobsInnerTimeLimit(val *V0041OpenapiSlurmdbdJobsRespJobsInnerTimeLimit) *NullableV0041OpenapiSlurmdbdJobsRespJobsInnerTimeLimit {
	return &NullableV0041OpenapiSlurmdbdJobsRespJobsInnerTimeLimit{value: val, isSet: true}
}

func (v NullableV0041OpenapiSlurmdbdJobsRespJobsInnerTimeLimit) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableV0041OpenapiSlurmdbdJobsRespJobsInnerTimeLimit) UnmarshalJSON(src []byte) error {
	v.isSet = true
