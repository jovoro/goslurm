...
type V0041JobDescMsg struct {
	...
	Priority *V0041OpenapiSlurmdbdJobsRespJobsInnerPriority `json:"priority,omitempty"`
	...
	TimeLimit *V0041OpenapiSlurmdbdJobsRespJobsInnerTimeLimit `json:"time_limit,omitempty"`
	...
	MemoryPerCpu *V0041OpenapiSlurmdbdJobsRespJobsInnerRequiredMemoryPerCpu `json:"memory_per_cpu,omitempty"`
	MemoryPerNode *V0041OpenapiSlurmdbdJobsRespJobsInnerRequiredMemoryPerCpu `json:"memory_per_node,omitempty"`
...
func (o *V0041JobDescMsg) GetPriority() V0041OpenapiSlurmdbdJobsRespJobsInnerPriority {
	if o == nil || IsNil(o.Priority) {
		var ret V0041OpenapiSlurmdbdJobsRespJobsInnerPriority
		return ret
	}
	return *o.Priority
}
...
// SetPriority gets a reference to the given V0041OpenapiSlurmdbdJobsRespJobsInnerPriority and assigns it to the Priority field.
...
func (o *V0041JobDescMsg) GetTimeLimit() V0041OpenapiSlurmdbdJobsRespJobsInnerTimeLimit {
	if o == nil || IsNil(o.TimeLimit) {
		var ret V0041OpenapiSlurmdbdJobsRespJobsInnerTimeLimit
		return ret
	}
	return *o.TimeLimit
}
...
// SetTimeLimit gets a reference to the given V0041OpenapiSlurmdbdJobsRespJobsInnerTimeLimit and assigns it to the TimeLimit field.
...
// SetMemoryPerCpu gets a reference to the given V0041OpenapiSlurmdbdJobsRespJobsInnerRequiredMemoryPerCpu and assigns it to the MemoryPerCpu field.
...
// SetMemoryPerNode gets a reference to the given V0041OpenapiSlurmdbdJobsRespJobsInnerRequiredMemoryPerCpu and assigns it to the MemoryPerNode field.
