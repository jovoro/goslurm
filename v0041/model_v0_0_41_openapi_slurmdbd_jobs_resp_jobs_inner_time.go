...
type V0041OpenapiSlurmdbdJobsRespJobsInnerTime struct {
	...
	Limit *V0041OpenapiSlurmdbdJobsRespJobsInnerTimeLimit `json:"limit,omitempty"`
...
// SetLimit gets a reference to the given V0041OpenapiSlurmdbdJobsRespJobsInnerTimeLimit and assigns it to the Limit field.
